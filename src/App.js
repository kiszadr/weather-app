...
class App extends Component {
  ...
  getData () {
    return axios.get('https://api.openweathermap.org/data/2.5/forecast?lat=54.372158&lon=18.638306&APPID=5b38fbd15002feaef5198fc90fb05c41')
    .then(
      response => {
  ...
  render() {
    ...
    return (
      <div>
        ...
        : <h1 className="app__title">No data to show</h1>
        }
      </div>
    );
  }
